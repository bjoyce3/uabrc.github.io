...
- Batch jobs: Scripts to submit to the SLURM scheduler. Should run with no researcher input or graphical researcher interface (GUI). Replicates commands in an order you would run them on the command line.
